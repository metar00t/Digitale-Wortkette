...
the developers managing, developing and maintaining this open source project. In return,
they should reciprocate that respect in addressing your issue, assessing
changes, and helping you finalize your pull requests.

## Using the issue tracker

First things first: **Do NOT report security vulnerabilities in public issues!** Please disclose responsibly by letting [the Backend Developer](mailto:david-paul.adams@outlook.de?subject=Security) know upfront. They will assess the issue as soon as possible on a best-effort basis and will give you an estimate for when they have a fix and release available for an eventual public disclosure.
...
> Where / when does the issue occur?
> 
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/metar00t/<repo-name>
   ```

2. If you cloned a while ago, get the latest changes from the whole repository:
...
### For Members of the "Digitale-Wortkette" Team

1. Clone the repo and create a branch

   ```bash
   git clone https://github.com/metar00t/<repo-name>
   cd <repo-name>
   git switch -c <topic-branch-name>
   ```
...
2. Check that a change has any necessary documentation.
3. If there is anything you don’t like, leave a comment below the respective
   lines and submit a "Request changes" review. Repeat until everything has
   been addressed.
4. If you are not sure about something, mention the specific
   people for help in a comment.
5. If there is only a tiny change left before you can merge it and you think
...
6. Once everything looks good, add an "Approve" review. Don’t forget to say
   something nice 👏🐶💖✨
7. If the commit messages follow [our conventions](https://conventionalcommits.org)
...
8. If the commit messages _do not_ follow our conventions
...
git switch <feature-branch> # replace name with your branch
git rebase main
git switch main
